        ...
        private void UpdateTiles()
        {
            for (int i = 0; i < difficulty; i++)
            {
                ...
                if (tile != null && musicalBtn != null)
                {
                    ...
                    // Проверка на пропуск через интерфейс (2)
                ...
                {
                    if (rand.NextDouble() < 0.02 + score * 0.0005) // усложнение
                        SpawnTile(i);
                }
            }
